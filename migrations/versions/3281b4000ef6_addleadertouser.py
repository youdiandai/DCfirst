...
Revision ID: 3281b4000ef6
Revises: d9e84cf6582a
Create Date: 2017-09-01 11:42:56.665925
...
revision = '3281b4000ef6'
down_revision = 'd9e84cf6582a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('user', sa.Column('leader', sa.String(length=64), nullable=True))
    op.create_unique_constraint(None, 'user', ['leader'])
